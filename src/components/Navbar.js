  ...
  return (
    <nav className="bg-white border-gray-200 py-2.5 rounded dark:bg-gray-900">
      <div className="relative container flex flex-wrap items-center justify-between mx-auto">
        ...
        <div className={`${mobileIsOpen ? "absolute top-10" : "hidden"} w-full md:block md:w-auto`} id="navbar-default">
